    ...
    <div className='pl-[12%] mt-14 flex flex-col gap-[100px]'>
            ...
            <div className='flex flex-col gap-5 w-[60%]'>
                <div className='flex gap-[420px] w-[25%]'>
                    <div className='flex gap-[525px] w-[25%]'>
                        ...
                        <Image src='/up-right-arrow.png' width={20} height={20}  alt='image'  className='invert' />
                    </div>
                </div>
        ...
        <div className=''>
            <div className='flex gap-[35px]'>
                <Image src='/v1.png' width={800} height={200}  alt='image'  className='w-[25%] h-[20%] rounded-[35px] border-[1px] border-red-500' />
                {/* first div */}
                <div className='w-[52%] flex flex-col gap-[120px] bg-[rgb(24,25,30)] p-[20px] rounded-[28px] border-[1px] border-[rgb(95,36,36)]'>
                    <div className='flex items-center justify-between'>
                        <div className='flex items-center gap-[20px]'>
                            <Image src='/old-man.jpg' width={50} height={90}  alt='image'  className='rounded-[50%] h-[50px]' />
                    ...
                    <div className='flex justify-between items-center'>
                        ...
                        <Image src='/up-right-arrow.png' width={50} height={10}  alt='image'  className='invert h-[35px] w-[35px]' />
                    </div>
                </div>
            </div>
            <div className='flex gap-[55px] items-center'>
                ...
                <div className='mt-[20px] flex gap-[55px]'>
                    <Image src='/v2.png' width={800} height={200} alt='image'  className='w-[400px] h-[290px] rounded-[35px] border-[1px] border-red-500' />
                    <Image src='/v3.png' width={800} height={200} alt='image'  className='w-[400px] h-[290px] rounded-[35px] border-[1px] border-red-500' />
                 </div>
